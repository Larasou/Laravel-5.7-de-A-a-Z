...
{{ Form::model($project, $route) }}
    ...
    <div class="py-3">
        {{ Form::dateTimeLocal('published_at', $project->published_at, ['class' => 'bg-form', 'placeholder' => 'Description du projet']) }}
        {!! $errors->first('published_at', '<p class="text-red-darker text-lg font-bold">:message</p>') !!}
    </div>
